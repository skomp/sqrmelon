...
float EQ_Coeff[10][3] = 
{
	...
	{ 0.996881485f, 0.00155912153f, 1.99686241 }
#endif
};
...
void SYNTHCALL BOWED_tick(SynthNode* n)
{
	...
	NODE_UPDATE_BEGIN   
		...
		// delay pointers
		n->v[11].i[1] = (int)(n->customMem);
		n->v[11].i[2] = (int)(n->customMem+9840*4);		
	...
	sample_t bpos = s_toInt(n->v[0]);
	(((sample_t*)n->v[11].i[1])[bpos.i[0]]).d[0] = neckReflection.d[0];
	(((sample_t*)n->v[11].i[1])[bpos.i[1]]).d[1] = neckReflection.d[1];

	// neck delay new input	
	bpos = s_toInt(n->v[1]);
	(((sample_t*)n->v[11].i[2])[bpos.i[0]]).d[0] = bridgeReflection.d[0];
	(((sample_t*)n->v[11].i[2])[bpos.i[1]]).d[1] = bridgeReflection.d[1];	
